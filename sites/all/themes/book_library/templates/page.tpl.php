        ...
        <div class="sidebar" id="sidebar">
            ...
            <div id="menu_style" class="menu_style">
                <ul class="nav nav-list" id="nav_list">
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle">
                            <i class="icon-list-alt"></i><span class="menu-text"> 数据管理 </span><b class="arrow icon-angle-down"></b>
                        </a>
                        <ul class="submenu">
...
<div class="modal fade" id="modalAPIupdate" tabindex="-1" role="dialog"
     aria-labelledby="modalAPIAddLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalAPIAddLabel">修改规范档</h4>
            </div>
            <div class="modal-body ">
                <form class="form-horizontal" id="addUserForm">
                    <div class="form-group">
